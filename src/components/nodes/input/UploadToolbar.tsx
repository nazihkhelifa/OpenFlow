      ...
      >
        ...
        >
          {mode === "image" ? (
            ...
            <button type="button" onClick={() => hasMedia && setToolsOpen((open) => !open)} disabled={!hasMedia} className="flex h-8 w-fit items-center justify-center gap-1 whitespace-nowrap rounded-xl border-none pl-2 pr-1 text-neutral-100 hover:bg-white/5 disabled:pointer-events-none disabled:cursor-default disabled:opacity-50">
              <span>Tools</span>
            </button>
          )}
